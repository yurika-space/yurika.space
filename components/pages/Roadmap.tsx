...
export const RoadmapSection: React.FC = () => {
  ...
  return (
    <Section sectionId="roadmap" background="gradient-purple" className="relative">
      {/* Background invaders */}
      <InvaderField count={50} color="var(--secondary-foreground)"/>

      <div className="relative z-10">
        <div className="text-center mb-12">
          <h2 className="font-mono text-2xl md:text-3xl text-foreground mb-2">
            WE&apos;RE BUILDING THE INFRASTRUCTURE
          </h2>
          <h3 className="font-mono text-xl md:text-2xl text-theme-primary">
        ...
        <SectionGrid columns={3} gap="lg">
          {phases.map((phase, i) => (
            <motion.div
              ...
              className={cn(
                "p-6 border-2 transition-transform",
            ...
            >
              ...
              <h4 className="font-mono text-lg font-bold mb-4 text-foreground">
                {phase.title}
              </h4>
              <ul className="space-y-2 font-mono text-sm text-theme-muted">
